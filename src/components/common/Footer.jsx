    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-xl font-bold mb-4">🚗 Driver Trip</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/trips" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Viajes
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/rewards" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Recompensas
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} Driver Trip. Todos los derechos reservados.
          </p>
